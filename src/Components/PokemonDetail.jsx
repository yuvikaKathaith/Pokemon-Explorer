...
const PokemonDetail = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-6 mb-10 bg-white shadow-lg rounded-lg font-mono">
      <div className="flex flex-col items-center gap-6 md:flex-row">
        ...
        />
        <div>
          <h2 className="text-5xl font-bold capitalize mb-2 text-yellow-600">{pokemon.name}</h2>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-1 text-emerald-500">Types</h3>
      ...
      <div className="mt-6">
        <h3 className="text-2xl font-semibold mb-2 text-red-700">Stats</h3>
      ...
      <div className="mt-6">
        <h3 className="text-2xl font-semibold mb-2 text-green-700">Abilities</h3>
      ...
      <div className="mt-6">
        <h3 className="text-2xl font-semibold mb-2 text-blue-700">Moves</h3>
